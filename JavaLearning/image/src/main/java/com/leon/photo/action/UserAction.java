...
import com.leon.photo.service.ImageService;
import com.leon.photo.service.UserService;
		...
		{ //用户登录
			...
			else
			{
				...
				else
				{
					...
					request.setAttribute("imageList", imageService.getByUserId(user.getId()));
					result = "5";
				}
			}
			out.print(result);
