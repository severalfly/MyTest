  ...
  <body>
                    ...
                    <div class="row">
                        <div class="col-xs-2 col-xs-offset-2">
                          <a href="#" class="thumbnail text-center">
                            <img name="${image.name}"  style="width: 140px; height: 130px;" src="http://oou15cuq6.bkt.clouddn.com/${image.url}"><!--这里请填写自己的链接地址，详见下图-->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            //点击确定退出
            $('#exit').click(function() {
                $.get('UserAction?type=3', function(data, status) {
